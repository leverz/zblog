...
![杠杆点转移：从提示词到系统设计](imgs/loop-engineering/01-leverage-shift.png)
...
![四条件测试](imgs/loop-engineering/02-four-conditions.png)
...
所以正确顺序其实很朴素：
![最小可用循环的四个组件](imgs/loop-engineering/03-loop-components.png)
...
![理解债务：系统增长快于理解增长](imgs/loop-engineering/04-comprehension-debt.png)
