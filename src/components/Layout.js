      ...
      <div className="cyberpunk-theme">
        ...
        >
          ...
          <footer className="cyberpunk-footer">
            ...
            <FooterItem title="NETWORK">
              <li>
                <a href="https://github.com/leverz" target="_blank" rel="noopener noreferrer">
              ...
              <li>
                <a href="https://twitter.com/lever_z" target="_blank" rel="noopener noreferrer">
                  <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <title>Twitter</title>
          ...
          <div style={{ 
            ...
            © {new Date().getFullYear()} // FIGHT UNTIL DIE
          </div>
        </div>
      </div>
    )
